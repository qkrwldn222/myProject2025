...
public class WaitingController implements WaitingSwagger {
    ...
    @Override
    @PostMapping("/leave")
    public ResponseEntity<ApiResponseWrapper<Void>> leaveQueue(@RequestParam("restaurantId") Long restaurantId) {
    ...
    @Override
    @PostMapping("/allow")
    public ResponseEntity<ApiResponseWrapper<Void>> allowNextUser(@RequestParam("restaurantId") Long restaurantId) {
    ...
    public SseEmitter subscribe(@RequestParam("restaurantId") Long restaurantId, @RequestParam("userId") String userId) {
        return sseEmitterService.subscribe(userId, restaurantId);
    }

    @Override
    @GetMapping("/enter")
    public ResponseEntity<ApiResponseWrapper<Void>> enterNextUser(@RequestParam("restaurantId") Long restaurantId) {
