...
public interface RestaurantSwagger {
  ...
  ResponseEntity<ApiResponseWrapper<Void>> deleteRestaurant(@PathVariable("restaurantId") Long restaurantId);
  ...
  ResponseEntity<ApiResponseWrapper<Void>> operateOperatingHours(
      @PathVariable("restaurantId") Long restaurantId, @RequestBody RestaurantOperatingHoursOperateRequest request);
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(
                            ...
                            content = @Content(mediaType = "application/json", schema = @Schema(implementation = RestaurantSearchRegistrationsResponse.class))
                    ),
                    @ApiResponse(
                            responseCode = "403",
                            description = "권한 없음",
    ...
    ResponseEntity<ApiListResponse<RestaurantSearchRegistrationsResponse>> searchRestaurantRegistrations(
    ...
    @Operation(
            ...
            security = @SecurityRequirement(name = "BearerAuth"),
            parameters = {
                    @Parameter(name = "state", description = "처리 상태 (APPROVED / REJECTED)", required = true, example = "APPROVED"),
