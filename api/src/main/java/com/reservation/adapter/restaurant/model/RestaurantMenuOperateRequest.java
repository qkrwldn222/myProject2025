...
public class RestaurantMenuOperateRequest {
  @Schema(description = "새로운 메뉴 추가 요청 목록", example = "[{\"name\": \"스테이크\", \"description\": \"숙성 스테이크\", \"price\": 35000, \"imageUrl\": \"https://example.com/steak.jpg\", \"isBest\": true}]")
  private List<RestaurantMenuCreateRequest> createRequests;

  @Schema(description = "기존 메뉴 수정 요청 목록", example = "[{\"menuId\": 1, \"name\": \"새우볶음밥\", \"description\": \"새우가 가득한 볶음밥\", \"price\": 12000, \"imageUrl\": \"https://example.com/shrimp_rice.jpg\", \"isBest\": false}]")
