...
public class RestaurantSeatOperateRequest {
  @Schema(description = "새로운 좌석 추가 요청 목록", example = "[{\"seatType\": \"TABLE\", \"seatNumber\": \"A1\", \"maxCapacity\": 4, \"isAvailable\": true}]")
  private List<RestaurantSeatCreateRequest> createRequests;

  @Schema(description = "기존 좌석 수정 요청 목록", example = "[{\"seatId\": 3, \"seatType\": \"PRIVATE\", \"seatNumber\": \"VIP1\", \"maxCapacity\": 10, \"isAvailable\": false}]")
