...
public class RestaurantOperatingHoursOperateRequest {
  @Schema(
      description = "새로운 운영 시간 추가 요청 목록",
      example =
          "[{\"dayOfWeek\": \"MON\", \"openTime\": \"09:00\", \"closeTime\": \"21:00\", \"isHoliday\": false}]")
  private List<RestaurantOperatingHoursCreateRequest> createRequests;

  @Schema(
      description = "기존 운영 시간 수정 요청 목록",
      example =
          "[{\"operatingHoursId\": 5, \"dayOfWeek\": \"FRI\", \"openTime\": \"10:00\", \"closeTime\": \"23:00\", \"isHoliday\": false}]")
