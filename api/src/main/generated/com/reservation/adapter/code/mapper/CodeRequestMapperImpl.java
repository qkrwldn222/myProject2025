...
public class CodeRequestMapperImpl implements CodeRequestMapper {
  ...
  public CodeOperateCommand toOperateCommand(CodeOperateRequest request) {
    ...
    codeOperateCommand.setSaveCommands(
        codeSaveRequestListToCodeSaveCommandList(request.saveRequests()));
    codeOperateCommand.setUpdateCommands(
        codeUpdateRequestListToCodeUpdateCommandList(request.updateRequests()));
    codeOperateCommand.setDeleteCommands(
        codeDeleteRequestListToCodeDeleteCommandList(request.deleteRequests()));
  ...
  protected List<CodeSaveCommand> codeSaveRequestListToCodeSaveCommandList(
      List<CodeSaveRequest> list) {
    if (list == null) {
      return null;
    }
  ...
  protected CodeUpdateCommand codeUpdateRequestToCodeUpdateCommand(
  ...
  protected List<CodeUpdateCommand> codeUpdateRequestListToCodeUpdateCommandList(
      List<CodeUpdateRequest> list) {
    if (list == null) {
      return null;
    }
  ...
  protected CodeDeleteCommand codeDeleteRequestToCodeDeleteCommand(
      CodeDeleteRequest codeDeleteRequest) {
  ...
  protected List<CodeDeleteCommand> codeDeleteRequestListToCodeDeleteCommandList(
      List<CodeDeleteRequest> list) {
    if (list == null) {
      return null;
    }
