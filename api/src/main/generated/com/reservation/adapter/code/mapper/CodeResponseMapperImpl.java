...
public class CodeResponseMapperImpl implements CodeResponseMapper {
    ...
    @Override
    public GroupCodeAdaptSearchResponse toGroupCodeSearchAdaptResponse(GroupCodeSearchResponse groupCodeSearchResponse) {
    ...
    @Override
    public List<GroupCodeAdaptSearchResponse> toGroupCodeSearchAdaptResponses(List<GroupCodeSearchResponse> groupCodeSearchResponses) {
        if ( groupCodeSearchResponses == null ) {
            return null;
        }

        List<GroupCodeAdaptSearchResponse> list = new ArrayList<GroupCodeAdaptSearchResponse>( groupCodeSearchResponses.size() );
